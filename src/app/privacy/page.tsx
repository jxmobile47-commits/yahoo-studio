      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mb-8">
          ...
          <div className="space-y-4 text-gray-700 dark:text-gray-300">
            <p>
              Yahoo Studio is a research project developed at California State University, Fullerton.
        ...
        <div className="mb-8">
          ...
          <div className="space-y-4 text-gray-700 dark:text-gray-300">
            <p>Yahoo Studio integrates with the following third-party services:</p>
            <ul className="space-y-3">
