            ...
            <div className="space-y-16">
              ...
              <section id="welcome" className="scroll-mt-8">
                <div className="text-center space-y-4">
                  ...
                  <h1 className="text-4xl sm:text-5xl font-extrabold text-gray-900 dark:text-white leading-tight">
                    Yahoo Studio API Documentation
                  </h1>
              ...
              <section id="getting-started" className="scroll-mt-8">
                ...
                <div className="prose prose-gray dark:prose-invert max-w-none mb-8">
                  <p>
                    The Yahoo Studio API provides powerful audio analysis capabilities with no authentication required. Start making requests immediately to analyze audio files and extract musical information.
                  </p>
                </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-700 dark:text-gray-300">
                        The Yahoo Studio API is currently open and does not require authentication. All endpoints are publicly accessible,
              ...
              <section id="rate-limits" className="scroll-mt-8">
                ...
                <div className="prose prose-gray dark:prose-invert max-w-none mb-8">
                  <p>
                    The Yahoo Studio API implements production-grade rate limiting to ensure fair usage and system stability. Rate limits vary by endpoint based on computational requirements.
                  </p>
                </div>
              ...
              <section id="models" className="scroll-mt-8">
                ...
                <div className="prose prose-gray dark:prose-invert max-w-none mb-8">
                  <p>
                    Yahoo Studio provides multiple machine learning models for different audio analysis tasks. Each model is optimized for specific use cases and performance characteristics.
                  </p>
                </div>
              ...
              <section id="examples" className="scroll-mt-8">
                ...
                <div className="prose prose-gray dark:prose-invert max-w-none mb-8">
                  <p>
                    Here are some practical examples of how to use the Yahoo Studio API using Javascript and cURL.
                  </p>
                </div>
...
console.log(result);`}
  ...
  -F "model=chord-cnn-lstm"`}
              ...
              <section id="status" className="scroll-mt-8">
                ...
                <div className="prose prose-gray dark:prose-invert max-w-none mb-8">
                  <p>
                    Monitor the real-time status of Yahoo Studio API services and endpoints.
                  </p>
                </div>
