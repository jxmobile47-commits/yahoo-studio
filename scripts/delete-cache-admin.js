...
/**
 * Admin Cache Deletion Script for Yahoo Studio Application
 *
...
let projectId = process.env.NEXT_PUBLIC_FIREBASE_PROJECT_ID || 'yahoo-studio';
...
function showHelp() {
  console.log(`
🎵 Yahoo Studio Admin Cache Deletion Tool
...
async function main(cli = parseCliArgs(process.argv.slice(2))) {
  try {
    ...
    console.log('🎵 Yahoo Studio Admin Cache Deletion Tool\n');
