...
This is the shortest path. It pulls the current `yahoostudio/yahoo-studio-frontend:latest` and `yahoostudio/yahoo-studio-backend:latest` images from Docker Hub.
