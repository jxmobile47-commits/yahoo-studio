...
# Yahoo Studio Docker Image Publishing Script
...
# Configuration
DOCKER_USERNAME="yahoostudio"
FRONTEND_IMAGE="yahoo-studio:test"
BACKEND_IMAGE="yahoo-studio-backend:test"
FRONTEND_REPO="${DOCKER_USERNAME}/yahoo-studio-frontend"
BACKEND_REPO="${DOCKER_USERNAME}/yahoo-studio-backend"
...
echo -e "${BLUE}╔════════════════════════════════════════════════════════════╗${NC}"
echo -e "${BLUE}║         Yahoo Studio Docker Image Publisher               ║${NC}"
echo -e "${BLUE}╚════════════════════════════════════════════════════════════╝${NC}"
echo ""
