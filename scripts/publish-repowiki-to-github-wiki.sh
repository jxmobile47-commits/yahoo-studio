...
WIKI_REPO_URL="${WIKI_REPO_URL:-https://github.com/yahoostudio/yahoo-studio.wiki.git}"
WIKI_BASE_URL="${WIKI_BASE_URL:-https://github.com/yahoostudio/yahoo-studio/wiki}"
SOURCE_BLOB_URL="${SOURCE_BLOB_URL:-https://github.com/yahoostudio/yahoo-studio/blob/main}"
WIKI_WORKTREE="${WIKI_WORKTREE:-/tmp/yahoo-studio.wiki}"
