...
export const metadata: Metadata = {
  ...
  title: {
    default: 'Yahoo Studio - Chord Recognition and Beat Tracking with AI',
    template: '%s | Yahoo Studio'
  },
  ...
  authors: [
    {
      name: 'Yahoo Studio Team',
      url: ''
    }
  ],
  creator: 'Yahoo Studio Team',
  publisher: 'Yahoo Studio',
  ...
  openGraph: {
    type: 'website',
    locale: 'en_US',
    url: 'https://yahoo-studio.app',
    siteName: 'Yahoo Studio',
    title: 'Yahoo Studio - Chord Recognition and Beat Tracking with AI',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Yahoo Studio - Music Analysis Platform',
      },
    ],
  },
  twitter: {
  ...
  alternates: {
    canonical: 'https://yahoo-studio.app',
  },
};
...
export default function RootLayout({
  ...
  return (
    <html lang="en" className={`${robotoMono.variable} ${dmSans.variable} ${varelaRound.variable}`} suppressHydrationWarning>
      <head>
        {/* Remove browser extension injected scripts to prevent hydration mismatches */}
        <script
          dangerouslySetInnerHTML={{
            __html: `(function(){var extScripts=document.querySelectorAll('script[src*="cascade"],script[src*="windsurf"],script[src*="browser-integration"]');extScripts.forEach(function(s){s.remove()})})()`
          }}
        />
        ...
        <style dangerouslySetInnerHTML={{
          __html: `
            ...
            nav[data-yahoostudio-navigation="true"] {
              position: fixed;
              inset-inline: 0;
              top: 0;
              z-index: 100;
            ...
            .dark nav[data-yahoostudio-navigation="true"] { background: transparent; }
