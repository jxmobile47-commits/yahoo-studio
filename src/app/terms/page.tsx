      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mb-8">
          ...
          <div className="space-y-4 text-gray-700 dark:text-gray-300">
            <p>
              Welcome to Yahoo Studio, a research project developed at California State University, Fullerton.
              These Terms of Service govern your use of our AI-powered chord recognition platform.
            </p>
            <p>
              By using Yahoo Studio, you agree to these terms. Please read them carefully.
            </p>
          </div>
        </div>
        ...
        <div className="mb-8">
          ...
          <div className="space-y-4 text-gray-700 dark:text-gray-300">
            <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
              ...
              <p>
                Yahoo Studio is provided as a research tool for educational and academic purposes.
          ...
          <div className="space-y-6">
            <div>
              ...
              <ul className="space-y-2 text-gray-700 dark:text-gray-300">
                <li>• Use Yahoo Studio for personal music analysis and learning</li>
        ...
        <div className="mb-8">
          ...
          <div className="space-y-4 text-gray-700 dark:text-gray-300">
            <ul className="space-y-3">
              <li>• Yahoo Studio&apos;s source code and algorithms are owned by the research team</li>
        ...
        <div className="mb-8">
          ...
          <div className="space-y-4 text-gray-700 dark:text-gray-300">
            <div className="bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-lg p-4">
              ...
              <p>
                Yahoo Studio is provided &quot;as is&quot; without warranties. As a research project,
        ...
        <div className="mb-8">
          ...
          <div className="space-y-4 text-gray-700 dark:text-gray-300">
            <p>
              By using Yahoo Studio, you acknowledge that:
            </p>
            <ul className="space-y-2">
        ...
        <div className="mb-8">
          ...
          <div className="space-y-4 text-gray-700 dark:text-gray-300">
            ...
            <p>
              Continued use of Yahoo Studio after changes constitutes acceptance of the updated terms.
            </p>
          </div>
        </div>
