...
export async function generateMetadata({ params }: { params: Promise<{ videoId: string }> }): Promise<Metadata> {
  ...
  if (!videoId || typeof videoId !== 'string' || videoId.length !== 11) {
    return {
      title: 'Invalid Video | Yahoo Studio',
  ...
  try {
    ...
    // Fallback metadata
    return {
      title: `Music Analysis ${videoId} | Yahoo Studio`,
      description: `AI-powered chord recognition and beat detection analysis. Discover chord progressions, beats, and musical structure with Yahoo Studio's advanced music analysis tools.`,
      openGraph: {
        title: `Music Analysis ${videoId} | Yahoo Studio`,
        description: `AI-powered chord recognition and beat detection analysis. Discover chord progressions, beats, and musical structure with Yahoo Studio's advanced music analysis tools.`,
        url: `https://yahoo-studio.app/analyze/${videoId}`,
