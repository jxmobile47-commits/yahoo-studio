...
const SupportYahooStudio: React.FC = () => {
        ...
        <div className="p-3 w-full rounded-lg bg-white dark:bg-content-bg">
          ...
          {isExpanded && (
            <div id="support-actions-content" className="mt-4 space-y-3">
              ...
              <Button
                as="a"
                href="mailto:contact@yahoo-studio.app"
                variant="light"
                size="sm"
      ...
      <div className="bg-blue-50 dark:bg-blue-900/20 p-3 rounded-lg border border-blue-200 dark:border-blue-800">
        <div className="flex items-start gap-3">
          ...
          <div className="text-xs text-blue-700 dark:text-blue-200">
            ...
            <p>Yahoo Studio is an AI-powered music analysis platform. Your support helps advance music technology.</p>
          </div>
        </div>
      </div>
    </div>
...
export default SupportYahooStudio;