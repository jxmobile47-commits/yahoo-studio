# Contributing to Yahoo Studio

Thank you for your interest in contributing to Yahoo Studio! This guide will help you get started with contributing to our open-source music analysis tool for chords, beats, lyrics, and visualization workflows.
...
**Example**: `feat(chord-recognition): improve accuracy with CNN-LSTM`
...
Report security vulnerabilities to: security@yahoo-studio.app
...
- **Repository**: Yahoo Studio
- **Live Demo**: https://yahoo-studio.app
- **Maintainer**: Yahoo Studio Team
- **Email**: contact@yahoo-studio.app

Thank you for contributing to Yahoo Studio! 🎵
