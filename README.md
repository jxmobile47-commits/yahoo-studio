...
### 🏠 Homepage Interface
![Yahoo Studio Homepage Light](public/homepage.png)
![Yahoo Studio Homepage Dark](public/homepage_dark.png)
...
1. **Clone and install**
   ...
   ```bash
   git lfs install
   git clone --recursive https://github.com/your-username/yahoo-studio.git
   cd yahoo-studio
   git lfs pull
   npm install
   ```
...
ls -la python_backend/models/ChordMini/  # ML model name, not app name
```
...
> [!NOTE]
> If you are installing Yahoo Studio with Docker Desktop, start with the Docker guide.
...
Yahoo Studio provides production-ready Docker images for easy deployment:

```bash
# Production deployment with Docker Compose
curl -O https://raw.githubusercontent.com/your-username/yahoo-studio/main/docker-compose.prod.yml
docker compose -f docker-compose.prod.yml up -d
```

**Available on multiple registries:**
- **Docker Hub**: `yahoostudio/yahoo-studio-frontend:latest`, `yahoostudio/yahoo-studio-backend:latest`
- **GitHub Container Registry**: `ghcr.io/your-username/yahoo-studio/frontend:latest`
